...
module.exports = fexfetch = function() {
    const colors = {
        black: "\x1b[38;5;240m",
        light_black: "\x1B[38;5;250m",
        blue: "\x1b[34m",
        light_blue: "\x1B[94m",
        cyan: "\x1b[36m",
        light_cyan: "\x1B[96m",
    ...
    console.log(`    ${colors.black}H${colors.light_black}N ${colors.white}| ${colors.black}HOSTNAME: ${colors.white}${os.platform() !== "win32" ? readFileSync('/etc/hostname').toString() + "@" : ""}${os.hostname() || "N/A"}\n
